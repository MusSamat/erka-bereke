...
import {deliveryReducer} from "../../store/reducers/delivery_reducer";
import {delivery_action} from "../../store/actions/delivery_action";
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    </td>
                                                    {
                                                        item.product.percent > 0 ?
                                                            ...
                                                            :
                                                            <td className="price-col">{item.product.price.toFixed(2)}</td>
                                                    }
                                                    <td>
                                                    ...
                                                    </td>
                                                    {
                                                        item.product.percent > 0 ?
                                                            ...
                                                            :
                                                            <td className="total-col">{(item.product.price * item.quantity).toFixed(2)}</td>
                                                    }
                                ...
                                <div className="cart-bottom">
                                    ...
                                    <NavLink to="/cart" className="btn btn-outline-dark-2"><span
                                    ...
                                    <table className="table table-summary">
                                            ...
                                            <td>
                                                <div className="custom-control custom-radio">
                                                    <input type="radio" id="gorod" name="shipping"
                                                           className="custom-control-input"
                                                           onClick={() => {
                                                               dispatch(delivery_action(100))
                                                           }}
                                                           checked={del_cost === 100 }
                                            ...
                                            <td>
                                                <div className="custom-control custom-radio">
                                                    <input type="radio" id="region" name="shipping"
                                                           className="custom-control-input"
                                                           onClick={() => {
                                                               dispatch(delivery_action(250))
                                                           }}
                                                           checked={del_cost === 250 }
                                                    />
                                                    <label className="custom-control-label"
                                        ...
                                        </tr>
                                        {
                                            del_cost === -1 ? null :
                                                <tr className="summary-total">
                                                    <td>Доставка:</td>
                                                    <td>{del_cost === 0 ? "Бесплатно": del_cost}</td>
                                                </tr>
                                        }
