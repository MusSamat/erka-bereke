                                ...
                                <nav className="side-nav">
                                    <ul className="menu-vertical sf-arrows">
                                                        ...
                                                        <div className="menu-col">
                                                            <div className="row">
                                                                <div className="col-md-6">
                                                                    <div className="menu-title">Laptops & Computers
                                                                    </div>
                                                                    <ul>
                                        ...
                                        <li>
                                            <div className='menuLinkDiv'>
                                                <div className='menuLink'>
                                                    <img src="/assets/svg_logo/cosmetics.svg" style={{color: "black"}}
                                                         alt="fruits"/>
                                                    <a href="/categories" style={{fontWeight: 600, fontSize: 17}}>Кагаз,
                                                        косметика</a>
                                                </div>
                                                <i className='icon-angle-right'> </i>
                                            </div>
                                        ...
                                        <li>
                                            <div className='menuLinkDiv'>
                                                <div className='menuLink'>
                                                    ...
                                                    <a href="/categories" style={{fontWeight: 600, fontSize: 17}}>Бүбүк,
                                                        Оюнчуктар</a>
                                                </div>
                                                <i className='icon-angle-right'> </i>
                                            </div>
                                        ...
                                        <li>
                                            <div className='menuLinkDiv'>
                                                <div className='menuLink'>
                                                    ...
                                                    <a href="/categories"
                                                       style={{fontWeight: 600, fontSize: 17}}>Үй-тирикчилик</a>
                                                </div>
                                                <i className='icon-angle-right'> </i>
                                            </div>
                                        </li>
                                        <li>
                                            <div className='menuLinkDiv'>
                                                <div className='menuLink'>
                                                    ...
                                                    <a href="/categories"
                                                       style={{fontWeight: 600, fontSize: 17}}>Үй-жаныбарлары</a>
                                                </div>
                                                <i className='icon-angle-right'> </i>
                                            </div>
                                        </li>
                                        <li>
                                            <div className='menuLinkDiv'>
                                                <div className='menuLink'>
                                                    ...
                                                    <a href="/categories"
                                                       style={{fontWeight: 600, fontSize: 17}}>"Электроника</a>
                                                </div>
                                                <i className='icon-angle-right'> </i>
                                            </div>
                                        </li>
                            ...
                            <div className="header-dropdown-link">
                                ...
                                <a href="wishlist.html" className="wishlist-link">
                                    ...
                                    <span className="wishlist-count"
                                          style={{backgroundColor: "rgb(204, 188, 48)"}}>3</span>
