        ...
        <div className="container icon-boxes-section">
            <div className="icon-boxes-container py-4 bg-lighter mb-2 mt-2">
                <div
                    ...
                    <div
                        className="icon-box mb-0 d-md-flex align-items-md-center text-center text-md-left mx-md-0 mx-auto">
                    ...
                    <div
                        ...
                        <div className="icon-box-content">
                            <h3 className="icon-box-title font-size-normal mb-0 font-weight-bold text-uppercase second-primary-color">Quality
                                Support</h3>
                    ...
                    <div
                        ...
                        <div className="icon-box-content">
                            <h3 className="icon-box-title font-size-normal mb-0 font-weight-bold text-uppercase second-primary-color">JOIN
                                OUR NEWSLETTER</h3>
                            <p className="font-weight-light second-primary-color">10% off by subscribing to our
                                newsletter</p>
                        </div>
                    </div>
                </div>
