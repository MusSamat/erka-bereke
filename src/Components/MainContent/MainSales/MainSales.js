            ...
            <div className="row" style={{marginTop: 30}}>
                <div className="col-sm-6 col-lg-3">
                    <div className="banner banner-overlay">
                        ...
                        <div className="banner-content">
                            ...
                            <h3 className="banner-title text-white "><a href="#">Lighting {<br/>}& Accessories {<br/>}<span>25% off</span></a>
                            </h3>
                ...
                <div className="col-sm-6 col-lg-3 order-lg-last">
                    <div className="banner banner-overlay">
                        ...
                        <div className="banner-content">
                            ...
                            <h3 className="banner-title text-white"><a href="#">Anniversary {<br/>}Special{<br/>}<span>15% off</span></a>
                            </h3>
                            <a href="#" className="banner-link">Shop Now <i className="icon-long-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div className="col-lg-6">
                    <div className="banner banner-overlay">
                        ...
                        <div className="banner-content">
                            <h4 className="banner-subtitle d-none d-sm-block"  style={{color: "black"}}><a href="#">Amazing Value</a>
                            </h4>
                            <h3 className="banner-title " style={{color: "black"}}><a href="#">Clothes Trending {<br/>}Spring Collection
