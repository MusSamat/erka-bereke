...
const Order = (props) => {
    ...
    const ToggleFormBoxHandler = () => {
        if (formBoxButton.style.display === "none") {
            formBoxButton.style.display = "block"
            iconAngle.className = "icon-angle-up"
        } else {
            formBoxButton.style.display = "none"
            iconAngle.className = "icon-angle-down"
        }
    }
